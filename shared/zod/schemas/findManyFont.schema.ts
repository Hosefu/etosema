...
export const FontFindManySelectSchema: z.ZodType<Prisma.FontSelect> = z.object({
...
export const FontFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    family: z.boolean().optional(),
    url: z.boolean().optional(),
...
export const FontFindManySchema: z.ZodType<Prisma.FontFindManyArgs> = z.object({ select: FontFindManySelectSchema.optional(),  orderBy: z.union([FontOrderByWithRelationInputObjectSchema, FontOrderByWithRelationInputObjectSchema.array()]).optional(), where: FontWhereInputObjectSchema.optional(), cursor: FontWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FontScalarFieldEnumSchema, FontScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FontFindManyArgs>;

export const FontFindManyZodSchema = z.object({ select: FontFindManySelectSchema.optional(),  orderBy: z.union([FontOrderByWithRelationInputObjectSchema, FontOrderByWithRelationInputObjectSchema.array()]).optional(), where: FontWhereInputObjectSchema.optional(), cursor: FontWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FontScalarFieldEnumSchema, FontScalarFieldEnumSchema.array()]).optional() }).strict();