...
export const CaseBlockMediaFindFirstSelectSchema: z.ZodType<Prisma.CaseBlockMediaSelect> = z.object({
...
export const CaseBlockMediaFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    blockId: z.boolean().optional(),
    block: z.boolean().optional(),
    position: z.boolean().optional(),
...
export const CaseBlockMediaFindFirstSchema: z.ZodType<Prisma.CaseBlockMediaFindFirstArgs> = z.object({ select: CaseBlockMediaFindFirstSelectSchema.optional(), include: z.lazy(() => CaseBlockMediaIncludeObjectSchema.optional()), orderBy: z.union([CaseBlockMediaOrderByWithRelationInputObjectSchema, CaseBlockMediaOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseBlockMediaWhereInputObjectSchema.optional(), cursor: CaseBlockMediaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseBlockMediaScalarFieldEnumSchema, CaseBlockMediaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CaseBlockMediaFindFirstArgs>;

export const CaseBlockMediaFindFirstZodSchema = z.object({ select: CaseBlockMediaFindFirstSelectSchema.optional(), include: z.lazy(() => CaseBlockMediaIncludeObjectSchema.optional()), orderBy: z.union([CaseBlockMediaOrderByWithRelationInputObjectSchema, CaseBlockMediaOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseBlockMediaWhereInputObjectSchema.optional(), cursor: CaseBlockMediaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseBlockMediaScalarFieldEnumSchema, CaseBlockMediaScalarFieldEnumSchema.array()]).optional() }).strict();