...
export const DesignSystemFindFirstSelectSchema: z.ZodType<Prisma.DesignSystemSelect> = z.object({
...
export const DesignSystemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    typography: z.boolean().optional(),
    colors: z.boolean().optional(),
    links: z.boolean().optional(),
...
export const DesignSystemFindFirstSchema: z.ZodType<Prisma.DesignSystemFindFirstArgs> = z.object({ select: DesignSystemFindFirstSelectSchema.optional(),  orderBy: z.union([DesignSystemOrderByWithRelationInputObjectSchema, DesignSystemOrderByWithRelationInputObjectSchema.array()]).optional(), where: DesignSystemWhereInputObjectSchema.optional(), cursor: DesignSystemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DesignSystemScalarFieldEnumSchema, DesignSystemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DesignSystemFindFirstArgs>;

export const DesignSystemFindFirstZodSchema = z.object({ select: DesignSystemFindFirstSelectSchema.optional(),  orderBy: z.union([DesignSystemOrderByWithRelationInputObjectSchema, DesignSystemOrderByWithRelationInputObjectSchema.array()]).optional(), where: DesignSystemWhereInputObjectSchema.optional(), cursor: DesignSystemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DesignSystemScalarFieldEnumSchema, DesignSystemScalarFieldEnumSchema.array()]).optional() }).strict();