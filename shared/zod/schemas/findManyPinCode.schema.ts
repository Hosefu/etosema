...
export const PinCodeFindManySelectSchema: z.ZodType<Prisma.PinCodeSelect> = z.object({
...
export const PinCodeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    label: z.boolean().optional(),
    codeHash: z.boolean().optional(),
    code: z.boolean().optional(),
...
export const PinCodeFindManySchema: z.ZodType<Prisma.PinCodeFindManyArgs> = z.object({ select: PinCodeFindManySelectSchema.optional(), include: z.lazy(() => PinCodeIncludeObjectSchema.optional()), orderBy: z.union([PinCodeOrderByWithRelationInputObjectSchema, PinCodeOrderByWithRelationInputObjectSchema.array()]).optional(), where: PinCodeWhereInputObjectSchema.optional(), cursor: PinCodeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PinCodeScalarFieldEnumSchema, PinCodeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PinCodeFindManyArgs>;

export const PinCodeFindManyZodSchema = z.object({ select: PinCodeFindManySelectSchema.optional(), include: z.lazy(() => PinCodeIncludeObjectSchema.optional()), orderBy: z.union([PinCodeOrderByWithRelationInputObjectSchema, PinCodeOrderByWithRelationInputObjectSchema.array()]).optional(), where: PinCodeWhereInputObjectSchema.optional(), cursor: PinCodeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PinCodeScalarFieldEnumSchema, PinCodeScalarFieldEnumSchema.array()]).optional() }).strict();