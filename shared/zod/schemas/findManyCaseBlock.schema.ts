...
export const CaseBlockFindManySelectSchema: z.ZodType<Prisma.CaseBlockSelect> = z.object({
...
export const CaseBlockFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    caseId: z.boolean().optional(),
    case: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const CaseBlockFindManySchema: z.ZodType<Prisma.CaseBlockFindManyArgs> = z.object({ select: CaseBlockFindManySelectSchema.optional(), include: z.lazy(() => CaseBlockIncludeObjectSchema.optional()), orderBy: z.union([CaseBlockOrderByWithRelationInputObjectSchema, CaseBlockOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseBlockWhereInputObjectSchema.optional(), cursor: CaseBlockWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseBlockScalarFieldEnumSchema, CaseBlockScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CaseBlockFindManyArgs>;

export const CaseBlockFindManyZodSchema = z.object({ select: CaseBlockFindManySelectSchema.optional(), include: z.lazy(() => CaseBlockIncludeObjectSchema.optional()), orderBy: z.union([CaseBlockOrderByWithRelationInputObjectSchema, CaseBlockOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseBlockWhereInputObjectSchema.optional(), cursor: CaseBlockWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseBlockScalarFieldEnumSchema, CaseBlockScalarFieldEnumSchema.array()]).optional() }).strict();