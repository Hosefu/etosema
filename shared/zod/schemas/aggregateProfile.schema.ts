...
import { ProfileAvgAggregateInputObjectSchema as ProfileAvgAggregateInputObjectSchema } from './objects/ProfileAvgAggregateInput.schema';
import { ProfileSumAggregateInputObjectSchema as ProfileSumAggregateInputObjectSchema } from './objects/ProfileSumAggregateInput.schema';

export const ProfileAggregateSchema: z.ZodType<Prisma.ProfileAggregateArgs> = z.object({ orderBy: z.union([ProfileOrderByWithRelationInputObjectSchema, ProfileOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProfileWhereInputObjectSchema.optional(), cursor: ProfileWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), ProfileCountAggregateInputObjectSchema ]).optional(), _min: ProfileMinAggregateInputObjectSchema.optional(), _max: ProfileMaxAggregateInputObjectSchema.optional(), _avg: ProfileAvgAggregateInputObjectSchema.optional(), _sum: ProfileSumAggregateInputObjectSchema.optional() }).strict() as unknown as z.ZodType<Prisma.ProfileAggregateArgs>;

export const ProfileAggregateZodSchema = z.object({ orderBy: z.union([ProfileOrderByWithRelationInputObjectSchema, ProfileOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProfileWhereInputObjectSchema.optional(), cursor: ProfileWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), ProfileCountAggregateInputObjectSchema ]).optional(), _min: ProfileMinAggregateInputObjectSchema.optional(), _max: ProfileMaxAggregateInputObjectSchema.optional(), _avg: ProfileAvgAggregateInputObjectSchema.optional(), _sum: ProfileSumAggregateInputObjectSchema.optional() }).strict();