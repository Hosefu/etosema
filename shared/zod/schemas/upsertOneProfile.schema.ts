...
export const ProfileUpsertOneSchema: z.ZodType<Prisma.ProfileUpsertArgs> = z.object({ select: ProfileSelectObjectSchema.optional(),  where: ProfileWhereUniqueInputObjectSchema, create: z.union([ ProfileCreateInputObjectSchema, ProfileUncheckedCreateInputObjectSchema ]), update: z.union([ ProfileUpdateInputObjectSchema, ProfileUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.ProfileUpsertArgs>;

export const ProfileUpsertOneZodSchema = z.object({ select: ProfileSelectObjectSchema.optional(),  where: ProfileWhereUniqueInputObjectSchema, create: z.union([ ProfileCreateInputObjectSchema, ProfileUncheckedCreateInputObjectSchema ]), update: z.union([ ProfileUpdateInputObjectSchema, ProfileUncheckedUpdateInputObjectSchema ]) }).strict();