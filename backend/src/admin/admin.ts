    ...
    resources: [
      ...
      // ======================================================================
      {
        ...
        options: {
          ...
          showProperties: ['id', 'title', 'shortTitle', 'slug', 'year', 'summary', 'isNda', 'coverUrl', 'orderRank', 'createdAt', 'updatedAt'],
          editProperties: ['title', 'shortTitle', 'slug', 'year', 'summary', 'isNda', 'coverUrl', 'orderRank'],
      ...
      // ======================================================================
      {
        ...
        options: {
          ...
          editProperties: ['blockId', 'type', 'position', 'url', 'alt', 'aspectRatio'],
          sort: {
            sortBy: 'position',
            direction: 'asc',
          },
      ...
      // ======================================================================
      {
        ...
        options: {
          ...
          showProperties: ['id', 'label', 'accessAll', 'expiresAt', 'createdAt', 'updatedAt'],
      ...
      // ======================================================================
      {
        ...
        options: {
          ...
          showProperties: ['id', 'ip', 'userAgent', 'success', 'pinCodeId', 'createdAt'],
          actions: {
            new: { isVisible: false },
      ...
      // ======================================================================
      {
        ...
        options: {
          ...
          editProperties: ['title', 'description', 'contactsJson', 'projectsJson', 'socialsJson'],
          actions: {
